  ...
  return (
    <footer className="bg-white border-t border-brand-sakura/20 pt-24 pb-12 text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <h2 className="text-4xl sm:text-5xl font-display text-stone-800 mb-6 tracking-tight drop-shadow-sm">Dilan & Dilhara</h2>
